...
=======================================
[![CMSIS Compliance](https://img.shields.io/github/actions/workflow/status/Arm-Examples/AWS_MQTT_MutualAuth_Demo/ci.yml?logo=arm&logoColor=0091bd&label=CMSIS%20Compliance)](https://www.keil.arm.com/cmsis) 
